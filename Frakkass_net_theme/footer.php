<section class="banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2><?php echo get_theme_mod('banner_heading', 'Suivez-nous sur les réseaux sociaux'); ?>:</h2>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; Chris net Theme 2019. Tous droits réservés</p>
                </div>
            </div>
        </div>
    </footer>
