        ...
        <div class="container">
            <div class="col-md-12">
                <div class="showcase-content">
                    <h1><?php echo get_theme_mod('showcase_heading', 'Un thème Wordpress par Chris'); ?></h1>
                    <p class="lead"><?php echo get_theme_mod('showcase_text', 'A Wordpress Theme By Chris'); ?></p>
